...
class NewFollowersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: controller.newFollowers.isEmpty
          ? const Center(
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  ListView.builder(
                    shrinkWrap: true,
                    itemCount: controller.newFollowers.length,
                    itemBuilder: (context, index) =>
                        followerCardTool(controller.newFollowers[index]),
