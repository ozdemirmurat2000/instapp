...
class MeNotFollowingScreen extends StatelessWidget {
  MeNotFollowingScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: controller.meNotFollowing.isEmpty
          ? const Center(
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  ListView.builder(
                    shrinkWrap: true,
                    itemCount: controller.meNotFollowing.length,
                    itemBuilder: (context, index) =>
                        followerCardTool(controller.meNotFollowing[index]),
